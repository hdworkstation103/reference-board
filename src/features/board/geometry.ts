...
export const getItemHeight = (item: BoardImage) => item.width * item.aspect + CAPTION_HEIGHT + CARD_BORDER_HEIGHT
...
export const getGroupBounds = (ids: number[], images: BoardImage[]): GroupBounds | null => {
